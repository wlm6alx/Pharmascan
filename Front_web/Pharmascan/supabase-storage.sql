...
DROP POLICY IF EXISTS "Public read medication-photos" ON storage.objects;
CREATE POLICY "Public read medication-photos"
ON storage.objects FOR SELECT TO public
USING (bucket_id = 'medication-photos');

DROP POLICY IF EXISTS "Authenticated upload medication-photos" ON storage.objects;
CREATE POLICY "Authenticated upload medication-photos"
ON storage.objects FOR INSERT TO authenticated
